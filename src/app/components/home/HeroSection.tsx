    ...
    <main  className="relative flex h-screen  w-full flex-col items-center overflow-hidden">
      ...
      <section className="container mx-auto my-auto flex  w-full max-w-screen-xl flex-col lg:pb-[20rem]">
        ...
        <motion.article 
          ...
          >
          <h1 className="text-4xl font-bold  md:text-7xl text-black drop-shadow-sm lg:text-8xl">
            Step-up Your Stride
          </h1>
          <div className="space-y-3 lg:space-y-5  md:space-y-16">
            <p className="text-xl md:text-2xl md:mt-5  text-black">Premium Athletic Footwear</p>
